...
class Login:
    def __init__(self, window):
        ...
        label = Label(frame, text="Don't have an account?", fg='black', bg='#F3EEE5', font=('Inter Normal', 14),
                      padx=20, pady=20)
        ...
        def signup():
            ...
            gender_male_button = Radiobutton(window, text="Male", bg='#E2C5ED', fg='Black', font=('Arial', 14),
                                             variable=gender_var, value="Male")
            gender_male_button.place(x=230, y=265)

            gender_female_button = Radiobutton(window, text="Female", bg='#E2C5ED', fg='Black', font=('Arial', 14),
                                               variable=gender_var, value="Female")
            gender_female_button.place(x=299, y=265)

            gender_other_button = Radiobutton(window, text="Others", bg='#E2C5ED', fg='Black', font=('Arial', 14),
            ...
            user7_combobox = ttk.Combobox(frame_2, values=['Teacher', 'Student'], font=('Inter Normal', 15), width=15,
            ...
            button_register = Button(frame_2, pady=3, width=8, height=-9, border=0, text="Register", bg="#39339B",
                                     fg="White", font=("Inter Normal", 16), command=signup_function)
        ...
        def home_page():
            ...
            y = Label(frameofblack, text="We are dedicated to making the students", font=("Calibri", 11), bg="black",
                      fg="white")
            y.place(x=100, y=25)

            y1 = Label(frameofblack, text="learn various subjects and topics", font=("Calibri", 11), bg="black",
                       fg="white")
            y1.place(x=100, y=45)
            ...
            iused = Button(frameofblack, text="Images Used", font=("Calibri", 15, "bold"), bd=0, bg="black", fg="White",
                           command=imagesused)
        ...
        log_in = Button(frame, width=9, pady=3, text="Log in", bg="#2586DA", fg="White", border=0, font=('Calibri', 13),
                        command=home_page)

        log_in.place(x=113, y=252)

        sign_in = Button(frame, width=6, text='Sign up', border=0, bg='#F3EEE5', cursor='hand2', fg="Blue",
                         font=("Calibri", 15, 'bold', UNDERLINE), command=signup)
